      ...
      <div class="main">
        ...
        <div class="phone">
          ...
          <div class="box-bd">
            <div class="promo-list">
              <router-link :to="{ path: '/goods/details', query: {productID:4} }">
        ...
        <div class="appliance" id="promo-menu">
          ...
          <div class="box-bd">
            <div class="promo-list">
              <ul>
                <router-link :to="{ path: '/goods/details', query: {productID:2} }">
                  <li>
                    <img
                ...
                <router-link :to="{ path: '/goods/details', query: {productID:5} }">
                  <li>
                    <img
        ...
        <div class="accessory" id="promo-menu">
          ...
          <div class="box-bd">
            <div class="promo-list">
              <ul>
                <router-link :to="{ path: '/goods/details', query: {productID:6} }">
                  <li>
                    <img
...
export default {
  ...
  methods: {
    load() {
      ...
      this.getProduct(6, 'chargersList');
    },
    // 获取家电模块子组件传过来的数据
    getChildMsg(val) {
    ...
    getProduct(categoryID, val) {
      productsAPI
        ...
        .then(res => {
          if (res.status === 200) {
            this[val] = res.data.item
            // this.$set(this.$data,res.data.items,val)
          } else {
