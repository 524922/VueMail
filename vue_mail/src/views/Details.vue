    ...
    <div class="details-main">
      ...
      <div class="details-block">
        <el-carousel height="560px">
          <el-carousel-item  :key="productPictures.id">
            <img style="height: 560px;" :src="productPictures.img_path" />
          </el-carousel-item>
        </el-carousel>
      </div>
      <!-- 左侧商品轮播图END -->
      ...
      <div class="details-content">
        ...
        <img class="immgg" :src="productDetails.boss_avatar" alt>

        <p class="intro">{{ productDetails.info }}</p>
        <p class="store">LWGG专属</p>
        <p class="tis">店家名字 ： {{productDetails.boss_name}}</p>
        <div class="price">
...
#details .details-main .details-content .tis {
  display: block;
  font-size: 18px;
  color: rebeccapurple;
  border-bottom: 1px solid #e0e0e0;
...
#details .details-main .details-content .immgg {
  display: block;
  margin-left: auto;
  width: 40px;
  height: 40px;
