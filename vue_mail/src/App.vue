    ...
    <el-container>
              ...
              <div class="user-name">
                <el-dropdown>
                  ...
                  <el-dropdown-menu slot="dropdown">
                    <a href="https://blog.csdn.net/weixin_45304503" target="_blank">
                    ...
                    <router-link to="/persongoods">
                      <el-dropdown-item>个人商品</el-dropdown-item>
                    </router-link>
      ...
      <el-header v-show="$route.meta.showMenu!==false">
        ...
        >
          ...
          <el-menu-item index="/persongoods">个人商品</el-menu-item>
        ...
        <div class="footer">
          <div class="ng-promise-box">
            <div class="ng-promise">
              <p class="text">
                <a class="icon1" href="javascript:;">不接受退换货</a>
                <a class="icon2" href="javascript:;">不包邮！不喜滚！</a>
                <a class="icon3" style="margin-right: 0" href="javascript:;">无品质保证</a>
              </p>
            </div>
          </div>
          <div class="github">
            <a href="https://github.com/CocaineCong" target="_blank">
          ...
          <div class="mod_help">
            ...
            <a href="https://github.com/CocaineCong" target="_blank">CocaineCone</a>
          </div>
        </div>
      </el-footer>
      <!-- 底栏容器END -->
